...
{{--                    <ol class="breadcrumb">--}}
{{--                        <li class="breadcrumb-item"><a href="javascript:void(0);">Garizart</a></li>--}}
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="list-unstyled text-center text-muted mb-0 mt-2">
                        <li class="list-inline-item font-13"><i class="mdi mdi-album font-16 text-success mr-2"></i>Total Budget</li>
                        <li class="list-inline-item font-13"><i class="mdi mdi-album font-16 text-danger mr-2"></i>Amount Used</li>
                        <li class="list-inline-item font-13"><i class="mdi mdi-album font-16 text-purple mr-2"></i>Target Amount</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="card profile">
                <div class="card-body">
                    <div class="text-center">
                        <img src="images/users/user-3.jpg" alt="" class="rounded-circle img-thumbnail thumb-xl">
